...
async def api_blogs(*, page='1'):
    ...
    blogs = await Blog.findAll(orderBy='created_at desc', limit=(p.offset,
                                                                 p.limit))
...
async def api_get_users(*, page='1'):
    ...
    users = await User.findAll(orderBy='created_at desc', limit=(p.offset,
                                                                 p.limit))
    for u in users:
        u.passwd = '******'
...
async def authenticate(*, email, passwd):
    ...
    user = users[0]
    #check passwd:
    #VS sha1_passwd = '%s:%s' % (uid, passwd) in "api_register_user"
    sha1 = hashlib.sha1()
    ...
    logging.info('signin in success!')
    return r
